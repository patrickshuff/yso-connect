...
export async function GET() {
  ...
  const lines = [
    ...
    `funnel,billing_page_views,${metrics.current.billingPageViews},${metrics.previous.billingPageViews}`,
    `funnel,checkout_initiated,${metrics.current.checkoutInitiated},${metrics.previous.checkoutInitiated}`,
    `funnel,payments_completed,${metrics.current.paymentsCompleted},${metrics.previous.paymentsCompleted}`,
    "",
