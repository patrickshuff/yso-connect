...
import { submitGeneralSmsConsent } from "@/app/consent/actions";
...
const CONSENT_TEXT =
  "By providing your phone number and checking the box below, you consent to receive text messages from YSO Connect and affiliated youth sports organizations regarding team activities, game and practice schedules, cancellations, and important updates. Message frequency varies. Message and data rates may apply. Reply STOP to opt out at any time. Reply HELP for help.";

export function GeneralSmsConsentForm() {
  const [state, formAction, isPending] = useActionState(
    submitGeneralSmsConsent,
    {
      success: false,
      error: null,
    },
      ...
      <Card className="border-green-200 bg-green-50 dark:border-green-900 dark:bg-green-950">
        <CardContent className="flex flex-col items-center gap-4 py-12">
          ...
          <p className="max-w-md text-center text-muted-foreground">
            Thank you! Your SMS consent has been recorded. You will now receive
            text message updates from YSO Connect and affiliated organizations
      ...
      <CardContent>
        <form action={formAction} className="space-y-6">
          ...
          <div className="flex items-start gap-3">
            ...
            >
              I agree to receive text messages from YSO Connect and affiliated
              youth sports organizations as described above.
            </Label>
          </div>
